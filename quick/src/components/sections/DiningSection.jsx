...
const diningRestaurants = [
 ...
 { id: "1", name: "BBQ Tonight", cuisine: "BBQ, Pakistani", rating: 4.5, deliveryTime: "Book Table", location: "Karachi", image:d1 },
  ...
  { id: "4", name: "Monal", cuisine: "Pakistani, BBQ", rating: 4.7, deliveryTime: "Book Table", location: "Islamabad", image: d4 },
  { id: "5", name: "Kolachi", cuisine: "BBQ, Seafood", rating: 4.6, deliveryTime: "Book Table", location: "Karachi", image: d5 },
  ...
  { id: "8", name: "Xander’s", cuisine: "Continental, Pizza", rating: 4.3, deliveryTime: "Book Table", location: "Karachi", image: d8 },
  { id: "9", name: "Butt Sweets & Restaurant", cuisine: "Pakistani, Desi", rating: 4.2, deliveryTime: "Book Table", location: "Gujranwala", image: d9 },
  { id: "10", name: "Qabail", cuisine: "Afghani, BBQ", rating: 4.5, deliveryTime: "Book Table", location: "Peshawar", image: d10 },
  { id: "11", name: "Howdy", cuisine: "Burgers, Fast Food", rating: 4.3, deliveryTime: "Book Table", location: "Lahore", image: d11 },
  { id: "12", name: "Chop Chop Wok", cuisine: "Asian, Chinese", rating: 4.4, deliveryTime: "Book Table", location: "Karachi", image: d12 },
  { id: "13", name: "Tuscany Courtyard", cuisine: "Italian, Steaks", rating: 4.5, deliveryTime: "Book Table", location: "Islamabad", image: d13 },
  { id: "14", name: "Café Zouk", cuisine: "Continental, Pakistani", rating: 4.3, deliveryTime: "Book Table", location: "Lahore", image: d14 },
  { id: "15", name: "Bundu Khan", cuisine: "BBQ, Desi", rating: 4.4, deliveryTime: "Book Table", location: "Faisalabad", image: d15 },
  { id: "16", name: "Nando’s", cuisine: "Grilled Chicken, Portuguese", rating: 4.2, deliveryTime: "Book Table", location: "Karachi", image: d16 },
  { id: "17", name: "OPTP", cuisine: "Burgers, Fries", rating: 4.1, deliveryTime: "Book Table", location: "Lahore", image: d17 },
  { id: "18", name: "Ginsoy", cuisine: "Chinese, Asian", rating: 4.3, deliveryTime: "Book Table", location: "Karachi", image: d18 },
  { id: "19", name: "Zaiqa", cuisine: "Traditional Pakistani", rating: 4.4, deliveryTime: "Book Table", location: "Hyderabad", image: d19 },
  { id: "20", name: "Ambrosia", cuisine: "Continental, Fine Dining", rating: 4.6, deliveryTime: "Book Table", location: "Islamabad", image: d20 },
  { id: "21", name: "The Rice Bowl", cuisine: "Chinese, Thai", rating: 4.2, deliveryTime: "Book Table", location: "Lahore", image: d21 },
  { id: "22", name: "Usmania Restaurant", cuisine: "Pakistani, Mughlai", rating: 4.3, deliveryTime: "Book Table", location: "Quetta", image: d22 },
  { id: "23", name: "La Atrium", cuisine: "Fusion, Continental", rating: 4.5, deliveryTime: "Book Table", location: "Karachi", image: d23 },
  { id: "24", name: "Café De Brando", cuisine: "Continental, Fast Food", rating: 4.1, deliveryTime: "Book Table", location: "Sialkot", image: d24 },
  { id: "25", name: "Biryani Express", cuisine: "Biryani, Fast Food", rating: 4.2, deliveryTime: "Book Table", location: "Multan", image: d25 },
  { id: "26", name: "Ramada Roof Top", cuisine: "Fine Dining, BBQ", rating: 4.6, deliveryTime: "Book Table", location: "Lahore", image: d26 },
  { id: "27", name: "Savour Foods", cuisine: "Rice, Desi", rating: 4.0, deliveryTime: "Book Table", location: "Rawalpindi", image: d27 },
  { id: "28", name: "Shaheen Shinwari", cuisine: "Afghani, BBQ", rating: 4.4, deliveryTime: "Book Table", location: "Karachi",image :d28 },
  { id: "29", name: "Khyber Dodai", cuisine: "Pakistani, Tribal", rating: 4.3, deliveryTime: "Book Table", location: "Peshawar",image :d29 },
  { id: "30", name: "Layers Bakeshop", cuisine: "Desserts, Cakes", rating: 4.5, deliveryTime: "Book Table", location: "Lahore",image: d30 },
  { id: "31", name: "The Smokey Cauldron", cuisine: "Fast Food, Themed", rating: 4.6, deliveryTime: "Book Table", location: "Islamabad",image: d31 },
  { id: "32", name: "Espresso", cuisine: "Cafe, Coffee", rating: 4.3, deliveryTime: "Book Table", location: "Karachi", image: d32 },
  { id: "33", name: "The Patio", cuisine: "Fusion, Fine Dining", rating: 4.4, deliveryTime: "Book Table", location: "Karachi",image :d33 },
  { id: "34", name: "The Patio", cuisine: "Fusion, Fine Dining", rating: 4.4, deliveryTime: "Book Table", location: "Karachi",image: d34 },
  { id: "35", name: "Street 1 Cafe", cuisine: "Continental, Fusion", rating: 4.5, deliveryTime: "Book Table", location: "Islamabad", image: d35 },
  { id: "36", name: "Des Pardes", cuisine: "Desi, Pakistani", rating: 4.3, deliveryTime: "Book Table", location: "Rawalpindi", image:d36 },
  { id: "37", name: "Chaaye Khana", cuisine: "Tea, Snacks", rating: 4.2, deliveryTime: "Book Table", location: "Islamabad", image:d37 },
  { id: "38", name: "Bam-Bou", cuisine: "Asian, Thai", rating: 4.4, deliveryTime: "Book Table", location: "Lahore", image:d38 },
  { id: "39", name: "The Urban Cafe", cuisine: "Modern, Pakistani", rating: 4.3, deliveryTime: "Book Table", location: "Faisalabad", image:d39 },
